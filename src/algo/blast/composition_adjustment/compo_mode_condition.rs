...
use crate::algo::blast::composition_adjustment::composition_adjustment::COMPO_NUM_TRUE_AA;
pub const HIGH_PAIR_THRESHOLD: f64 = 0.4;
pub const LENGTH_LOWER_THRESHOLD: usize = 50;
pub const QUERY_MATCH_DISTANCE_THRESHOLD: f64 = 0.16;
pub const LENGTH_RATIO_THRESHOLD: f64 = 3.0;
pub const ANGLE_DEGREE_THRESHOLD: f64 = 70.0;
/// NCBI `HALF_CIRCLE_DEGREES` (`compo_mode_condition.c:39`).
pub const HALF_CIRCLE_DEGREES: f64 = 180.0;
...
pub fn s_high_pair_frequencies(letter_probs: &[f64], length: usize) -> bool {
...
pub fn s_high_pair_either_seq(p_query: &[f64], len1: usize, p_match: &[f64], len2: usize) -> bool {
...
pub fn s_test_to_apply_re_adjustment_conditional(
    len_query: usize,
    len_match: usize,
...
pub fn s_gather_letter_probs(prob28: &[f64], out20: &mut [f64; COMPO_NUM_TRUE_AA]) {
    use crate::algo::blast::composition_adjustment::composition_adjustment::TRUE_CHAR_POSITIONS;
